  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <iframe src="{{ route('admin.file_manager.show') }}" style="width: 100%; height: 500px; overflow: hidden; border: none;"></iframe>
      </div>
    </div>
  </div>
      ...
      var LFMButton = function(context) {
        ...
        var button = ui.button({
          ...
          click: function() {
            ...
            lfm({type: 'image', prefix: '/admin/file-manager'}, function(lfmItems, path) {
