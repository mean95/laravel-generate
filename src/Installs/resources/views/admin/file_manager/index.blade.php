...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('platform/admin/filemanager/img/72px color.png') }}">
  ...
  <link rel="stylesheet" href="{{ asset('platform/admin/filemanager/css/cropper.min.css') }}">
  <link rel="stylesheet" href="{{ asset('platform/admin/filemanager/css/dropzone.min.css') }}">
  <link rel="stylesheet" href="{{ asset('platform/admin/filemanager/css/mime-icons.min.css') }}">
  {{-- <style>{!! \File::get(base_path('vendor/unisharp/laravel-filemanager/public/css/lfm.css')) !!}</style> --}}
  {{-- Use the line below instead of the above if you need to cache the css. --}}
  <link rel="stylesheet" href="{{ asset('/platform/admin/filemanager/css/lfm.css') }}">
</head>
<body>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('admin.file_manager.upload') }}" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
  ...
  <script src="{{ asset('platform/admin/filemanager/js/cropper.min.js') }}"></script>
  <script src="{{ asset('platform/admin/filemanager/js/dropzone.min.js') }}"></script>
  <script>
  ...
  <script src="{{ asset('platform/admin/filemanager/js/script.js') }}"></script>
  <script>
